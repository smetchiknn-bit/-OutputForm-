...
export function processSMRUnik(smrData: any[][], svodData: any[][]): { data: any[][]; formulas: any[][] } {
  ...
  smrData[0][0] = 'ИД.КЕР';
  smrData[0][1] = 'с_Наименование.КЕР.репорт';
  smrData[0][2] = 'с_ЕдИзм.КЕР';
  smrData[0][3] = 'Объем.КЕР.сумм';
  smrData[0][4] = 'срСМР.ЕдИзм.в.Расчет.из.СодКЕР';
  smrData[0][5] = 'СМР.Всего.Сум.СодКЕР';
  smrData[0][6] = 'с_Состав.Работ';
  smrData[0][7] = 'с_ФЕР_КЕР.в.СР';
...
export function processTMZUnik(tmzData: any[][], svodData: any[][]): { data: any[][]; formulas: any[][] } {
  ...
  // Устанавливаем заголовки для всех колонок
  tmzData[0][0] = 'ИД.ТМЦ';
  tmzData[0][1] = 'с_Наименование.ТМЦ.репорт';
  tmzData[0][2] = 'с_ЕдИзм.ТМЦ';
  tmzData[0][3] = 'Объем.ТМЦ';
  tmzData[0][4] = 'с_Цена.в.Расчет.Тендер';
  tmzData[0][5] = 'с_ТМЦ.Всего.из.тендер.Сум';
